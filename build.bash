...
assets_rewrite_assets_go() {
  ...
  rm -rf $assets_go
  echo "// Package assets contains AUTOGENERATED assets info."    >> $assets_go
  echo "package assets"                                           >> $assets_go
  echo ""                                                         >> $assets_go
  ...
  echo ""                                                         >> $assets_go
  echo "  // Repository is the asset's repository"                >> $assets_go
  echo "  Repository = \"github.com/ooni/probe-assets\""          >> $assets_go
  echo ")"                                                        >> $assets_go
  echo ""                                                         >> $assets_go
  ...
  for name in $asn_database_name $ca_bundle_name $country_database_name; do
    ...
    echo "      URLPath: \"/releases/download/$1/$name\","        >> $assets_go
