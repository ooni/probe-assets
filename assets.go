// Package assets contains AUTOGENERATED assets info.
package assets

const (
	// Version contains the assets version.
	Version = 20191114171735
	...
	// Repository is the asset's repository
	Repository = "github.com/ooni/probe-assets"
)
...
var All = map[string]ResourceInfo{
	"asn.mmdb": ResourceInfo{
		URLPath:  "/releases/download/20191114171735/asn.mmdb",
	...
	"ca-bundle.pem": ResourceInfo{
		URLPath:  "/releases/download/20191114171735/ca-bundle.pem",
		GzSHA256: "567e022570ba95b07e6045859b9d10ec72b445076c535e48bab2c299234cea9d",
		SHA256:   "5cd8052fcf548ba7e08899d8458a32942bf70450c9af67a0850b4c711804a2e4",
	},
	"country.mmdb": ResourceInfo{
		URLPath:  "/releases/download/20191114171735/country.mmdb",
